...
TS_TOKENS = {
    "eos_token": "<ts>",
    "pad_token": "<|endoftext|>",
    "additional_special_tokens": ["<speaker1>", "<speaker2>","<future>"],
    "bos_token": "<|startofdata|>",
}
...
class SpokenDialogTokenizer(SpokenNormalizer):
    ...
    def __init__(self, pretrained_model_name_or_path="microsoft/DialoGPT-medium"):
        ...
        self.future_token = TS_TOKENS["additional_special_tokens"][2]
        self.future_token_id = self._tokenizer.convert_tokens_to_ids(self.future_token)
...
if __name__ == "__main__":
    ...
    ## added by b2
    tokenizer = SpokenDialogTokenizer("microsoft/DialoGPT-medium")
